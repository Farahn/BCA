...
def build_dictionaries(words, n_max = 5000):
    count = collections.Counter(words).most_common(n_max-3) #creates list of word/count pairs;
    dictionary = dict()
...
def read_test_train(glove_vocab, embedding_dict, embedding_dim, SEQUENCE_LEN = 50, SEQUENCE_LEN_D = 25,  dname = 'dict', tr = 0.8, max_vocab = 5000):   
